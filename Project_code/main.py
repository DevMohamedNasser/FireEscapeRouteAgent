...
def main():
    ...
    algorithm = input("Enter the algorithm to run (bfs, dfs, ucs, astar, ids, hill, compare, history): ").lower()
    valid_algorithms = ['bfs', 'dfs', 'ucs', 'astar', 'ids', 'hill', 'compare', 'history']
